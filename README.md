...
```php
'repository' => Gatekeeper\Repository\EloquentFeatureRepository::class
```
...
If you discover any security related issues, please email philspil66@gmail.com instead of using the issue tracker.
